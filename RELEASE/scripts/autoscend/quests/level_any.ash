...
void LX_handleIntroAdventures()
{
	...
	if (handling_choice())
	{
		...
		if ($ints[1046, 1405, 1416, 1419, 1446, 1450, 1464, 1480, 1503, 1507, 1519, 1531, 1552, 1559, 1594] contains choice)
		{
			...
			// 1594 is "Nice to Meat You", intro for Adventurer Meats World (Spring 2026 challenge path).
